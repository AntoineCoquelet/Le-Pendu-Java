 ...
 * FORMATION JAVA & GIT
 * VERSION 2
 * CLEAN AND FORMAT CODE by IntelliJ IDEA
 * */
...
class Le_Pendu{
    public static void main(String[] args){
        ...
        // tableau de mots
        String[] listMots = { "Bonjour", "Aurevoir", "Matin", "Midi", "Soir" };

        //Melanger les mots
        Random randomMot = new Random();
        int randomNum = randomMot.nextInt(5);

        //Choisir un mot aléatoirgit
    ...
    private static void jeux(String mot, String tiret)
    {
        Scanner input;
